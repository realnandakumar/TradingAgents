...
export function NwEnvelopeBlotter({ positions }: { positions: NwEnvelopePosition[] }) {
        ...
        <div className="border-r border-border min-w-0">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs font-mono">
              ...
              <tbody>
                {rows.map(({ p, live, stop, mtmPct, cushion, tight, crossAge, distPct, lower }) => (
                  <tr
                    key={p.ticker}
