"""Market Analyst variant for quick tech-analyze — no meta narration preamble."""
...
def create_tech_market_analyst(llm):
...
Use real numbers and zones; set entry_zone_low/high to 0 only if not applicable."""
        ...
        prompt = ChatPromptTemplate.from_messages(
            [
                (
                    "system",
                    "You are a technical market analyst producing a standalone report."
                    " Use the provided tools to fetch data and indicators."
                    " When finished, output only the final report — no process narration."
